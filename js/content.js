window.PASTA_CONTENT = {
  ...
  home: {
    ...
    title: "Pasta Oner je jedním z nejvýraznějších současných umělců české vizuální scény.",
    copy:
      "Dlouhodobě a systematicky reflektuje svým charakteristickým, smířlivým a neodsuzujícím způsobem soudobou popkulturní společnost v plné škále její významové, hodnotové i symbolické vrstevnatosti.",
    note:
      "Pro aktuální nabídku originálních prací přímo od autora prosím kontaktujte: telefonicky produkci na čísle +420 606 732 264 nebo e-mailem na pasta@pastaoner.cz.",
    links: [
      {
        index: "01",
        title: "Artworks",
  ...
  pages: {
    works: {
      kicker: "Artworks",
      title: "The focus of Pasta's work is acrylic painting and the creation of hanging paintings.",
      copy:
        "As well as the design of spatial objects, sculptures, installations, graphics and non-traditional innovative techniques."
    },
    exhibitions: {
      kicker: "Exhibitions",
      title: "Selected Collections",
      copy:
        "Solo Exhibitions / Group Exhibitions / Selected Exhibitions / Murals in Public Space"
    },
    interview: {
      kicker: "Interview",
      title: "„Jsem stejný jako ty“: od systémových řešení pop-artu k post-popkulturním fascinacím",
      copy:
        "Pasta Oner & Pavel Kubesa / Červen 2023"
    },
    about: {
      kicker: "About",
  ...
  contact: {
    ...
    csIntro:
      "Pro aktuální nabídku prací prosím kontaktujte: telefonicky produkci na čísle +420 606 732 264 nebo e-mailem na pasta@pastaoner.cz.",
    enIntro:
      "For current offer of works please contact: production on phone +420 606 732 264 or e-mail to pasta@pastaoner.cz.",
    social: [
  ...
  interview: {
    questionLabel: "Pavel Kubesa",
    answerLabel: "Pasta Oner",
    leadQuote:
      "Já o svojí tvorbě uvažuji ještě v jiném termínu. Říkám, že je post-popkulturní.",
    qa: [
      {
        question:
      ...
      {
        question: "Tím bys v podstavě úplně popřel svou minulost.",
        answer: [
      ...
      {
        question: "Nestálo by za to učinit třeba i nějaké výtvarné gesto? Výstavu „No more graffiti any more / I am not graffiti artist“ ?",
        answer: [
